...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  $dataMere = [
    ...
    $dataEnfant = [
      ...
      'sexe' => $_POST['sexe'],
      'vaccin_bcg' => $_POST['vaccin_bcg'] == "true" ? true : false,
      'vaccin_polio' => $_POST['vaccin_polio'] == "true" ? true : false,
      'poids' => $_POST['poids'],
    ];
                ...
                <div class="card-body">
                  ...
                  <form class="form-sample" action="enregistrer.php" method="Post">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          <label class="col-sm-3 col-form-label">Vaccin polio</label>
                          <div class="col-sm-9">
                            <input type="checkbox" name="vaccin_polio" value="true" id="nom_doc" class="form-control" required/>
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group row">
                          <label class="col-sm-3 col-form-label">Vaccin bcg</label>
                          <div class="col-sm-9">
                            <input type="checkbox" name="vaccin_bcg" value="true" id="postnom_doc" class="form-control" required/>
                          </div>
                        </div>
                      </div>
                    </div>
