...
<div class="container mt-5">
    ...
    <form class="mb-4" method="post" action="index.php">        
        <div class="mb-3">
            ...
            <input type="text" name="name_user" id="name_user" class="form-control" autocomplete="off" required>
        </div>
        <div class="mb-3">
            <label for="password_user" class="form-label">mot de passe utilisateur</label>
            <input type="text" name="password_user" id="password_user" class="form-control" autocomplete="off">
        </div>
